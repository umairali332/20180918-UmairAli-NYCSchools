...
public class AlamofireNetwork: Networking {
    ...
    public init(translation:TranslationLayer) {
    ...
    public func requestObject<T:Decodable>( _ requestConverter : RequestConverterProtocol, completionHandler : @escaping  DataResponseHandler<T>) -> Void {
